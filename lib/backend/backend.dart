...
import 'schema/seller_ratings_record.dart';
...
import 'schema/payment_success_record.dart';
...
export 'schema/seller_ratings_record.dart';
...
export 'schema/payment_success_record.dart';
...
/// Functions to query SellerRatingsRecords (as a Stream and as a Future).
Future<int> querySellerRatingsRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      SellerRatingsRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<SellerRatingsRecord>> querySellerRatingsRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      SellerRatingsRecord.collection,
      SellerRatingsRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<SellerRatingsRecord>> querySellerRatingsRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
/// Functions to query PaymentSuccessRecords (as a Stream and as a Future).
Future<int> queryPaymentSuccessRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      PaymentSuccessRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<PaymentSuccessRecord>> queryPaymentSuccessRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      PaymentSuccessRecord.collection,
      PaymentSuccessRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<PaymentSuccessRecord>> queryPaymentSuccessRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
