...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: 'cartpayment',
          path: '/cartpayment',
          builder: (context, params) => CartpaymentWidget(),
        ),
        FFRoute(
          name: 'paymentmethod',
          path: '/paymentmethod',
        ...
        FFRoute(
          name: 'myFatoorahPayment',
          path: '/myFatoorahPayment',
          builder: (context, params) => MyFatoorahPaymentWidget(
            ...
            translationid: params.getParam(
              'translationid',
              ParamType.String,
            ),
            last4Number: params.getParam(
              'last4Number',
              ParamType.String,
            ),
            ...
            invoicestatus: params.getParam(
              'invoicestatus',
              ParamType.String,
            ),
            invoicereference: params.getParam(
              'invoicereference',
              ParamType.String,
            ),
            ...
            customermobile: params.getParam(
              'customermobile',
              ParamType.String,
            ),
