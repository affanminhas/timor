...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFFC48A07);
  late Color secondary = const Color(0xFF431D02);
  late Color tertiary = const Color(0xFFF7F4F8);
  late Color alternate = const Color(0xFFE3E3E3);
  late Color primaryText = const Color(0xFF001D24);
  late Color secondaryText = const Color(0xFF121622);
  late Color primaryBackground = const Color(0xFFFFFFFF);
  late Color secondaryBackground = const Color(0xFFF7F4F8);
  late Color accent1 = const Color(0xFF282B2B);
  late Color accent2 = const Color(0xFFFF5963);
  late Color accent3 = const Color(0xFFFF5963);
  late Color accent4 = const Color(0xFFEEEEEE);
  late Color success = const Color(0xFF04A24C);
  late Color warning = const Color(0xFFFCDC0C);
  late Color error = const Color(0xFFD14149);
  late Color info = const Color(0xFF1C4494);

  late Color customColor1 = Color(0xFF6D9400);
}
